...
ActiveRecord::Schema.define(version: 2021_12_02_093808) do
  ...
  create_table "buys", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["user_purchase_id"], name: "index_buys_on_user_purchase_id"
  end
  ...
  create_table "user_purchases", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["item_id"], name: "index_user_purchases_on_item_id"
  ...
  add_foreign_key "buys", "user_purchases"
